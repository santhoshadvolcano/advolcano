      ...
      <div className="relative z-10 w-full px-4 sm:px-6 py-12 sm:py-20 flex items-center min-h-screen bg-black/20">
        <div className="max-w-4xl">
          ...
          <p className="text-base sm:text-lg text-white/90 mb-6 sm:mb-8 leading-relaxed drop-shadow-md">
            ...
            AdVolcano.io is a next-gen Ad-Network engineered for scale, speed, and ROI.
          </p>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8 sm:mb-12">
            <Link href="/demo" className="bg-amber-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-amber-700 font-semibold text-sm sm:text-base whitespace-nowrap cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300">
              Start Campaign Now
            </Link>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
            <Link href="/demo" className="bg-white/20 backdrop-blur-sm border border-white/30 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl hover:bg-white/30 font-semibold text-xs sm:text-sm whitespace-nowrap cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              DSP Platform
            </Link>
