        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link href="/" className="font-medium whitespace-nowrap cursor-pointer transition-colors text-slate-600 hover:text-slate-900">
                Platform
              </Link>
              <Link href="/advertiser" className="font-medium whitespace-nowrap cursor-pointer transition-colors text-slate-600 hover:text-slate-900">
                Advertiser
              </Link>
              <Link href="/publisher" className="font-medium whitespace-nowrap cursor-pointer transition-colors text-slate-600 hover:text-slate-900">
                Publisher
              </Link>
              <Link href="/paypercall" className="font-medium whitespace-nowrap cursor-pointer transition-colors text-slate-600 hover:text-slate-900">
                PayPerCall Network
              </Link>
              <Link href="/ad-formats/detailed" className="font-medium whitespace-nowrap cursor-pointer transition-colors text-slate-600 hover:text-slate-900">
                Ad Formats
              </Link>
