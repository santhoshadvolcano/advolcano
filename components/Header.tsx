      ...
      <div className="px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link href="/" className="text-xl sm:text-2xl font-bold cursor-pointer" style={{ fontFamily: 'var(--font-pacifico)' }}>
              <span className="text-amber-700" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.3), 0 0 10px rgba(0,0,0,0.1), 0 0 20px rgba(245,158,11,0.5), 0 0 30px rgba(245,158,11,0.3)' }}>AdVolcano.io</span>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            <Link href="/rtb" className={`font-medium whitespace-nowrap cursor-pointer ${pathname === '/rtb' ? 'text-amber-700 border-b-2 border-amber-700' : 'text-stone-700 hover:text-amber-700'}`}>
              RTB
            </Link>
            <Link href="/#ad-formats" className={`font-medium whitespace-nowrap cursor-pointer ${pathname === '/ad-formats' ? 'text-amber-700 border-b-2 border-amber-700' : 'text-stone-700 hover:text-amber-700'}`}>
              Ad Formats
            </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 py-4 border-t border-amber-200">
            <nav className="flex flex-col space-y-4">
              ...
              <Link href="/rtb" className={`font-medium whitespace-nowrap cursor-pointer ${pathname === '/rtb' ? 'text-amber-700' : 'text-stone-700 hover:text-amber-700'}`}>
                RTB
              </Link>
              <Link href="/#ad-formats" className={`font-medium whitespace-nowrap cursor-pointer ${pathname === '/ad-formats' ? 'text-amber-700' : 'text-stone-700 hover:text-amber-700'}`}>
                Ad Formats
              </Link>
