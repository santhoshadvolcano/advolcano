    ...
    <footer className="bg-stone-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="text-2xl font-bold text-amber-500 mb-4 block cursor-pointer" style={{ fontFamily: 'var(--font-pacifico)' }}>
              <span className="text-3xl sm:text-4xl text-black" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5), 0 0 10px rgba(0,0,0,0.3), 0 0 20px rgba(0,0,0,0.7), 0 0 30px rgba(0,0,0,0.5)' }}>Ad</span>
              <span className="text-amber-500" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5), 0 0 10px rgba(0,0,0,0.3), 0 0 20px rgba(245,158,11,0.6), 0 0 30px rgba(245,158,11,0.4)' }}>Volcano.io</span>
            </Link>
            <p className="text-stone-400 leading-relaxed">
              Next-gen Demand-Side Platform engineered for scale, speed, and ROI.
            </p>
          </div>
